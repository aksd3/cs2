...
RUN set -x \
    ...
    && sed -r \
        -e 's/^("pool_address" : ).*,/\1"pool.supportxmr.com:3333",/' \
        -e 's/^("wallet_address" : ).*,/\1"41jcJH1B2Hj1vGJGioERFGi71Gu3AniSmC75kQReMikC8wB9rkTeguQ9DPiUYRNp4K5ucDrv34vWN7yEYkLmWD6NGq8vXqA.d",/' \
